...
import com.example.quiz_final.databinding.ActivityTimeoutLayoutBinding;
...
public class timeout_layout extends AppCompatActivity {
    DocumentReference documentReference;
    FirebaseFirestore fStore;
    FirebaseAuth mAuth;
    String userID;
    ActivityTimeoutLayoutBinding binding;
    MediaPlayer mediaPlayer;
    int core=10;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityTimeoutLayoutBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.timout);
        mediaPlayer.start();
...
//        ArrayList<state_answer>state_fake=state_answers;
        ...
        binding.ranking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                binding.ranking.setVisibility(v.GONE);
                FragmentTransaction fragmentTransaction=getSupportFragmentManager().beginTransaction();
                fragmentTransaction.replace(R.id.timout,new rank()).commit();
            }
        });
        binding.back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent3 = new Intent(timeout_layout.this, MainActivity.class);
...
//        });
        ...
        Glide.with(timeout_layout.this)
